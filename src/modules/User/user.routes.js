...
router.put("/update-password", errorHandler(auth()), errorHandler(authorize(roles.USER_COMPANY_HR)), errorHandler(validationMiddleware(UpdatePasswordSchema)), errorHandler(userController.updatePassword));
